...
def Main():
    ...
    Exit.pack(side=LEFT)
    Title = Label(Top, text="StopWatch by Sivaprasad", font=("arial", 24), fg="red", bg="black")
    Title.pack(fill=X)
...
class StopWatch(Frame):
    ...
    def MakeWidget(self):
        timeText = Label(self, textvariable=self.timestr, font=("arial", 45), fg="blue", bg="black")
